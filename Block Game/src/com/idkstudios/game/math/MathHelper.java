...
public class MathHelper {
	 ...
	 */
	private static double lerp(double x, double x1, double x2, double q00,
			double q01) {
	 ...
	 */
	public static double biLerp(double x, double y, double q11, double q12,
			double q21, double q22, double x1, double x2, double y1, double y2) {
	 ...
	 */
	public static double triLerp(double x, double y, double z, double q000,
			double q001, double q010, double q011, double q100, double q101,
