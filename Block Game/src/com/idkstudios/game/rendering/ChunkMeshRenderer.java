...
public class ChunkMeshRenderer {
	...
	public static void renderChunkMesh(Chunk chunk, MeshType meshType) {
		...
		GL11.glVertexPointer(POSITION_SIZE, GL11.GL_FLOAT, STRIDE * FLOAT_SIZE,
				POSITION_OFFSET * FLOAT_SIZE);
		GL11.glTexCoordPointer(TEX_COORD_SIZE, GL11.GL_FLOAT, STRIDE
				* FLOAT_SIZE, TEX_COORD_OFFSET * FLOAT_SIZE);
		GL11.glColorPointer(COLOR_SIZE, GL11.GL_FLOAT, STRIDE * FLOAT_SIZE,
				COLOR_OFFSET * FLOAT_SIZE);
