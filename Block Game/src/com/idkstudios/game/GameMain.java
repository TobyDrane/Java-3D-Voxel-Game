...
public class GameMain {
	...
	public static void test() {
		...
		for (long i = 0; i < 90000000000l; ++i) {
			...
			// boolean correct = (0 <= relativeX && relativeX <
			// CHUNK_SIZE_HORIZONTAL && 0 <= relativeZ && relativeZ<
			// CHUNK_SIZE_HORIZONTAL);

			// boolean experiment = (((relativeX | relativeZ) & 0xFFFFFFF0) ==
			// 0);
