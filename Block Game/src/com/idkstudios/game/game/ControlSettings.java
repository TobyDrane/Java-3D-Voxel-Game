...
public class ControlSettings {
	...
	public static void intializeAzerty() {
		...
		configureAction(FLY, false, Keyboard.KEY_C);
	...
	public static void intializeQwerty() {
		...
		/**
		 * Left mouse button is 0 : Right mouse button is 1
		 */
		configureAction(BUILD_OR_ACTION, true, 1);
		configureAction(SMASH, true, 0);
