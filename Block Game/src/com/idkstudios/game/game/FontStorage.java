...
public class FontStorage {
	...
	public static GLFont loadFont(String id, InputStream in, float size)
			throws IOException {
		try {
			GLFont font = new GLFont(Font.createFont(Font.TRUETYPE_FONT, in)
					.deriveFont(size));
			map.put(id, font);
			return font;
		} catch (FontFormatException ex) {
			Logger.getLogger(FontStorage.class.getName()).log(Level.SEVERE,
					null, ex);
		}
		return null;
	}

	public static GLFont loadFont(String id, String resource, float size)
			throws IOException {
