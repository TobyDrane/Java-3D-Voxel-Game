package com.idkstudios.game.utils;
...
public final class PerlinNoise {
		...
		return lerp(
				...
				lerp(v,
						...
						lerp(u, grad(p[AB], x, y - 1, 0),
								grad(p[BB], x - 1, y - 1, 0))),
				lerp(v,
						lerp(u, grad(p[AA + 1], x, y, -1),
								grad(p[BA + 1], x - 1, y, -1)),
						lerp(u, grad(p[AB + 1], x, y - 1, -1),
								grad(p[BB + 1], x - 1, y - 1, -1))));
	...
	private static void shuffleArray(int[] array, int lower, int upper,
			SmartRandom random) {
